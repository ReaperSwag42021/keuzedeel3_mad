...
- **Lichte en donkere modus** (light/dark mode)
- Ontwerp geïnspireerd op tijd (klok-iconen en rustige kleurstelling)
...
Dit is een schoolproject. Wil je het openbaar delen, dan kun je er een licentie aan toevoegen
(bijvoorbeeld [MIT](https://choosealicense.com/licenses/mit/)).
